...
void EINT0_IRQHandler (void)
{
    ...
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 0); // Clear the interrupt flag for EINT0
}
...
void EINT1_IRQHandler(void) {
    ...
    if (isPaused) {
        // Pause the game
        disable_timer(1);
        GUI_Text(100, 180, (uint8_t *)"PAUSED", 0xF800, 0x0000);
    } else {
        // Resume the game
        enable_timer(1);
        GUI_Text(100, 180, (uint8_t *)"       ", 0x0000, 0x0000);
    }

    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 1); // Clear KEY1 interrupt flag
}
