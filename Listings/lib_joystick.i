...
void CheckWinner();
# 11 "Source/joystick\\joystick.h" 2
...
void joystick_init(void) {
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~((3 << 26) | (3 << 25) | (3 << 24) | (3 << 23) | (3 << 22)); // Set GPIO mode for joystick pins
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~((1 << 29) | (1 << 28) |
                           (1 << 27) | (1 << 26) |
                           (1 << 25)); // Set as inputs
}
//void joystick_init(void) {
...
// ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 29); // Set P1.29 as input
